...
import com.frsummit.HRM.api.rmi.entity.Message;
import com.frsummit.HRM.api.rmi.entity.Payroll;
import com.frsummit.HRM.api.rmi.entity.Role;
...
public class HRMRemoteService {
	...
	public Iterable<Links> getAllLinks() throws RemoteException {
		return (Iterable<Links>) (new LocalProxy(hrmStub, Constances.LINKS_GET_ALL_PARAMS)).callWith(new Object[0]);
	}

	@SuppressWarnings("unchecked")
	public Iterable<Message> getAllMessages() throws RemoteException {
		return (Iterable<Message>) (new LocalProxy(hrmStub, Constances.MESSAGE_GET_ALL_PARAMS)).callWith(new Object[0]);
	}
	...
	public User updateUser(String userId, String fn, String mn, String ln, String email, String dept, String desg,
			...
			Address psa, Address pma, String nationality, String role, String imageName, String incomeTexNo, int active)
	...
	public Attendance removeAttendanceFromRemarkList(String attendId) throws RemoteException {
		(new LocalProxy(hrmStub, Constances.ATTENDANCE_REMOVE_FROM_REMARK_LIST)).callWith(new Object[] { attendId });
		return this.getAttendanceById(Integer.parseInt(attendId));
	}
	...
	public Iterable<Payroll> getAllPayrolls() throws RemoteException {
		return (Iterable<Payroll>) (new LocalProxy(hrmStub, Constances.PAYROLL_GET_ALL)).callWith(new Object[] {});
	}
